...
\begin{figure}[H]
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (2.5,-0.7) {\textbf{p-Halbleiter}};
        ...
        \end{tikzpicture}
    \end{center}
    \caption[Struktur NMOS-Transistor]{\\Quelle: Eigene Darstellung Struktur NMOS-Transistor in Anlehnung an \cite[S. 106]{Göbel2019}}
